...
function NavBar() {
  ...
  return (
    <div className="top-0 w-full z-[2020] translate-y-0 fixed">
      <div className=" z-[-1] opacity-[1] absolute h-14 w-[100%] bg-[#0f0f0f]  "></div>
      <div className="h-14 pr-4 pl-7 flex flex-row items-center justify-between relative max-sm:p-0 ">
        <div className="flex flex-row ">
          <div className="w-10 h-10 mr-3 p-5 box-border ">
            <button
              className="align-middle outline-none bg-none m-0 border-none p-0 w-[100%] h-[100%] leading-0 cursor-pointer  "
              onClick={() => toogleMenuHandler()}
            >
              <div className="flex justify-center items-center ">
                <div className=" flex justify-center items-center absolute bottom-0 top-0 h-[100%]">
                  <MenuRoundedIcon className="bg-transparent !fill-white" />
                </div>
              </div>
            </button>
          </div>
          <div className="w-[6rem] h-9 bg-transparent mt-3 max-sm:w-[5rem] max-sm:ml-2">
            <a href="/">
              <div className="">
                <svg
                  viewBox="0 0 90 20"
        ...
        <SearchBar />
        <div className="flex flex-0.5 p-2 max-sm:p-0 max-sm:basis-0 max-sm:hidden">
          <div className="flex flex-row ">
            <VideoCallOutlinedIcon className="text-white mr-7" />
            <Badge
              badgeContent={9}
              color="error"
              anchorOrigin={{
            ...
            <Avatar
              sx={{ height: 30, width: 30, backgroundColor: purple[500] }}
            >
              M
            </Avatar>
          </div>
